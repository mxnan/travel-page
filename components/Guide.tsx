      ...
      w-full pb-24">
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="regular-16 text-gray-30 xl:max-w-[520px]">
            ...
            Suscipit consectetur quam saepe dolores culpa id officiis
             possimus, perspiciatis consequatur nam nulla cumque quae 
             tempore dolor voluptate natus unde, error velit. Lorem 
          ...
          />
            <div className="flexBetween flex-col">
              ...
              <div className="flex w-full flex-col">            
                ...
                <h4 className="bold-20 mt-2 whitespace-nowrap">Wonore Pasuruan</h4>
              </div>
